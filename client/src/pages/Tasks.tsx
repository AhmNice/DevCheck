        ...
        <div className="relative">
          <div className="flex flex-col p-2 border-b border-b-gray-400/20">
            <div className="py-4">
              ...
              <p className="text-md text-gray-400 mt-0.5 ">
                You have 4 tasks in progress for this week
              </p>
            </div>
            <div className="flex gap-2">
              <button
                onClick={() => setIsActive("all")}
                className={`flex items-center gap-3 px-5 py-2 rounded-full transition-all duration-200 ${isActive === "all" ? "bg-primary text-white" : "bg-white text-gray-700"} `}
              >
                All Tasks
              </button>
              <button
                onClick={() => setIsActive("progress")}
                className={`flex items-center gap-3 px-5 py-2 rounded-full transition-all duration-200 ${isActive === "progress" ? "bg-primary text-white" : "bg-white text-gray-700"} `}
              >
                In Progress
              </button>
              <button
                onClick={() => setIsActive("review")}
                className={`flex items-center gap-3 px-5 py-2 rounded-full transition-all duration-200 ${isActive === "review" ? "bg-primary text-white" : "bg-white text-gray-700"} `}
              >
                Review
              </button>
              <button
                onClick={() => setIsActive("backlog")}
                className={`flex items-center gap-3 px-5 py-2 rounded-full transition-all duration-200 ${isActive === "backlog" ? "bg-primary text-white" : "bg-white text-gray-700"} `}
              >
                Backlog
              </button>
            </div>
          ...
          <div className="flex  p-6 mt-20 cursor-pointer bottom-0 right-0 sticky items-end justify-end">
            <button
              ...
              className="rounded-full cursor-pointer px-4 font-bold py-4 hover:bg-primary-700  hover:scale-105 bg-primary text-white transition-all delay-150 duration-150"
            >
