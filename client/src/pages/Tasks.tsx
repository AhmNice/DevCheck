      ...
      <DashboardLayout>
        <div className="relative">
          <div className="flex flex-col p-4 border-b border-b-gray-400/20">
            <div className="p-2">
              ...
              <p className="text-xs text-gray-400 mt-0.5 mb-5">
                You have 8 tasks in progress for this week
              </p>
            </div>
          ...
          <div className="flex  p-6 mt-20 cursor-pointer bottom-0 right-0 sticky items-end justify-end">
            <button className="rounded-full cursor-pointer px-4 font-bold py-4 hover:bg-blue-700  hover:scale-105 bg-blue-500 text-white transition-all delay-150 duration-150">
